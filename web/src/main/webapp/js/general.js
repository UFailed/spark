...
$(document).ready(function (e) {
    ...
    //图片描述
    $(".pic_area .pic_show").mouseenter(function () {
        $(this).children(".pic_info").animate({marginTop: "55px"}, 200);
    });
    $(".pic_area .pic_show").mouseleave(function () {
        $(this).children(".pic_info").animate({marginTop: "90px"}, 200);
    });
    //幻灯片
