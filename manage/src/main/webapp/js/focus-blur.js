$(document).ready(function () {
    ...
    $("input").focus(function () {
        ...
        if (TextInputVal == "搜索帖子、用户" || TextInputVal == "在这里输入标题，最多输入30个文字" || TextInputVal == "可不选" || TextInputVal == "搜索关注的人" || TextInputVal == "搜索粉丝" || TextInputVal == "搜索黑名单" || TextInputVal == "搜索私信" || TextInputVal == "搜索系统消息" || TextInputVal == "搜索评论" || TextInputVal == "开始日期" || TextInputVal == "结束日期" || TextInputVal == "搜索我的帖子") {
            $(this).val("");
            $(this).css("color", "#666");
        }
